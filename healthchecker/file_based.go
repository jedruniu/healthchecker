...
func NewFileBasedHealthCheck(name, filename string, interval time.Duration) HealthChecker {
	return &fileBasedHealthCheck{filename, &CommonHealthCheck{name, interval}}
}
